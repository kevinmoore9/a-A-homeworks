...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("brownie", "10", "Steve")}.to raise_error
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["sugar","mix","something_else"]
      ingredients.each do |i|
        brownie.ingredients << i
      end
      brownie.mix!
  ...
  describe "#serve" do
    ...
    expect(brownie.serve).to eq("Chef John the Great Baker has made 50 brownies!")
  end
  end
